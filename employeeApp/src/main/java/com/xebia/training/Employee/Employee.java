...
public class Employee {
    ...
    public List<Future<List<SalaryDetails>>>  salary;
    public List<Future<List<Project>>> projectData;
    ...
    public Employee(String name, Date startingDate, String fathersName,
                    ...
                    String workEx, String gender, Date dOB, int id,List<Future<List<SalaryDetails>>>  salary,List<Future<List<Project>>> projectData,
