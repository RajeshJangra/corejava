...
import com.xebia.training.Classes.ContactDetails.AddressType;

public class ContactDetailsData implements Callable<List<ContactDetails>>{
	public static final String input="/home/jasleen/corejava/employeeApp/src/main/java/com/XmlFiles/ContactDetails.xml";
	 double ContactId;
